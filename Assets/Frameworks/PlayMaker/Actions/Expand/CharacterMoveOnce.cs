...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Moves a Game Object with a Character Controller. See also Controller Simple Move Once. NOTE: It is recommended that you make only one call to Move or SimpleMove per frame.")]
	public class ControllerMoveOnce : FsmStateAction
	{
		[RequiredField]
