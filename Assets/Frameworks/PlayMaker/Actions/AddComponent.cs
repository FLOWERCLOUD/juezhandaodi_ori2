...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class AddComponent : FsmStateAction
	{
		...
		void DoAddComponent()
		{
			...
			addedComponent = UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(go, "Assets/Frameworks/PlayMaker/Actions/AddComponent.cs (56,21)", component.Value);
